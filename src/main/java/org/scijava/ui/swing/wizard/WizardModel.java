 ...
 * http://java.sun.com/developer/technicalArticles/GUI/swing/wizard/ The model
 * for the Wizard component, which tracks the text, icons, and enabled state of
 * each of the buttons, as well as the current panel that is displayed. Note
 * that the model, in its current form, is not intended to be subclassed.
 */
...
public class WizardModel {
	...
	private final HashMap panelHashmap;

	private final HashMap buttonTextHashmap;
	private final HashMap buttonIconHashmap;
	...
	WizardPanelDescriptor getPanelDescriptor(final Object id) {
	 ...
	 */
	void registerPanel(final Object id, final WizardPanelDescriptor descriptor) {
	 ...
	 */
	boolean setCurrentPanel(final Object id) {
		...
		final WizardPanelDescriptor oldPanel = currentPanel;
		currentPanel = nextPanel;

		if (oldPanel != currentPanel) firePropertyChange(
			CURRENT_PANEL_DESCRIPTOR_PROPERTY, oldPanel, currentPanel);
	...
	void setBackButtonText(final Object newText) {
	...
	void setNextFinishButtonText(final Object newText) {

		final Object oldText = getNextFinishButtonText();
		if (!newText.equals(oldText)) {
	...
	void setCancelButtonText(final Object newText) {
	...
	public void setNextFinishButtonIcon(final Icon newIcon) {
		...
		final Object oldIcon = getNextFinishButtonIcon();
		if (!newIcon.equals(oldIcon)) {
