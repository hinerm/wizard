 ...
 * http://java.sun.com/developer/technicalArticles/GUI/swing/wizard/ This class
 * is responsible for reacting to events generated by pushing any of the three
 * buttons, 'Next', 'Previous', and 'Cancel.' Based on what button is pressed,
...
public class WizardController implements ActionListener {
	 ...
	 */
	public WizardController(final Wizard w) {
		wizard = w;
	}
	...
	public void actionPerformed(final java.awt.event.ActionEvent evt) {
		...
		if (evt.getActionCommand().equals(Wizard.CANCEL_BUTTON_ACTION_COMMAND)) cancelButtonPressed();
		else if (evt.getActionCommand().equals(Wizard.BACK_BUTTON_ACTION_COMMAND)) backButtonPressed();
		else if (evt.getActionCommand().equals(Wizard.NEXT_BUTTON_ACTION_COMMAND)) nextButtonPressed();
	...
	private void nextButtonPressed() {
		...
		final Object nextPanelDescriptor = descriptor.getNextPanelDescriptor();
	...
	private void backButtonPressed() {
		...
		final Object backPanelDescriptor = descriptor.getBackPanelDescriptor();
	...
	void resetButtonsToPanelRules() {
		...
		if (descriptor.getBackPanelDescriptor() != null) model
			.setBackButtonEnabled(Boolean.TRUE);
		...
		if (descriptor.getNextPanelDescriptor() != null) model
			.setNextFinishButtonEnabled(Boolean.TRUE);
		else model.setNextFinishButtonEnabled(Boolean.FALSE);
